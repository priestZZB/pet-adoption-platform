/**
 * 中国省市区数据
 * 结构: { province: { city: [district, ...] } }
 */
export const regionData = {
  '北京市': {
    '北京市': ['东城区', '西城区', '朝阳区', '海淀区', '丰台区', '石景山区', '通州区', '顺义区', '大兴区', '昌平区', '房山区', '门头沟区', '怀柔区', '平谷区', '密云区', '延庆区']
  },
  '天津市': {
  ...
  '重庆市': {
    '重庆市': ['渝中区', '江北区', '南岸区', '沙坪坝区', '九龙坡区', '大渡口区', '北碚区', '渝北区', '巴南区', '万州区', '涪陵区', '长寿区', '江津区', '合川区', '永川区', '南川区', '綦江区', '大足区', '璧山区', '铜梁区', '潼南区', '荣昌区', '开州区', '梁平区', '武隆区']
  },
  '广东省': {
    ...
    '阳江市': ['江城区', '阳东区'],
    '清远市': ['清城区', '清新区'],
    '东莞市': ['莞城区', '南城区', '万江区', '东城区', '虎门镇', '长安镇', '厚街镇', '塘厦镇', '常平镇', '大朗镇'],
  ...
  '四川省': {
    '成都市': ['锦江区', '青羊区', '金牛区', '武侯区', '成华区', '龙泉驿区', '青白江区', '新都区', '温江区', '双流区', '郫都区', '新津区', '都江堰市', '彭州市', '邛崃市', '崇州市', '金堂县', '大邑县', '蒲江县'],
    '绵阳市': ['涪城区', '游仙区', '安州区', '江油市'],
  ...
  '河北省': {
    '石家庄市': ['长安区', '桥西区', '新华区', '裕华区', '井陉矿区', '藁城区', '鹿泉区', '栾城区', '晋州市', '新乐市', '正定县', '井陉县', '行唐县', '灵寿县', '高邑县', '深泽县', '赞皇县', '无极县', '平山县', '元氏县', '赵县'],
    ...
    '保定市': ['竞秀区', '莲池区', '满城区', '清苑区', '徐水区', '涿州市', '定州市', '安国市', '高碑店市', '涞水县', '阜平县', '定兴县', '唐县', '高阳县', '容城县', '涞源县', '望都县', '易县', '曲阳县', '蠡县', '顺平县', '博野县'],
  ...
  '河南省': {
    ...
    '商丘市': ['梁园区', '睢阳区', '永城市', '虞城县', '民权县', '宁陵县', '睢县', '夏邑县', '柘城县'],
  ...
  '安徽省': {
    ...
    '芜湖市': ['镜湖区', '弋江区', '鸠江区', '三山区', '湾沚区', '繁昌区', '无为市', '南陵县'],
  ...
  '江西省': {
    ...
    '新余市': ['渝水区', '分宜县'],
    '鹰潭市': ['月湖区', '余江区', '贵溪市'],
    '赣州市': ['章贡区', '南康区', '赣县区', '瑞金市', '信丰县', '大余县', '上犹县', '崇义县', '安远县', '定南县', '全南县', '宁都县', '于都县', '兴国县', '会昌县', '寻乌县', '石城县', '龙南市'],
  ...
  '陕西省': {
    ...
    '渭南市': ['临渭区', '华州区', '华阴市', '韩城市', '潼关县', '大荔县', '合阳县', '澄城县', '蒲城县', '白水县', '富平县'],
    ...
    '安康市': ['汉滨区', '旬阳市', '汉阴县', '石泉县', '宁陕县', '紫阳县', '岚皋县', '平利县', '镇坪县', '白河县'],
  ...
  '黑龙江省': {
    ...
    '伊春市': ['伊美区', '乌翠区', '友好区', '金林区', '铁力市', '嘉荫县', '汤旺县', '丰林县', '大箐山县', '南岔县'],
    '佳木斯市': ['前进区', '向阳区', '东风区', '郊区', '同江市', '富锦市', '抚远市', '桦南县', '桦川县', '汤原县'],
  ...
  '云南省': {
    ...
    '红河哈尼族彝族自治州': ['蒙自市', '个旧市', '开远市', '弥勒市', '建水县', '石屏县', '泸西县', '元阳县', '红河县', '绿春县', '屏边苗族自治县', '金平苗族瑶族傣族自治县', '河口瑶族自治县'],
  ...
  '台湾省': {
    ...
    '新北市': ['板桥区', '新庄区', '中和区', '永和区', '土城区', '树林区', '三重区', '芦洲区'],
  ...
  '澳门特别行政区': {
    '澳门': ['花地玛堂区', '花王堂区', '望德堂区', '大堂区', '风顺堂区', '嘉模堂区', '路凼城']
  }
}
